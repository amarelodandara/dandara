    ...
    <header data-paper data-perforated className="-mx-5 -mt-8 bg-shop-band">
      ...
      >
        ...
        <button
          ...
          data-pressable
          className="-mr-3 flex shrink-0 items-center rounded-lg bg-background px-2.5 py-2 shadow-cutout transition-[background-color,scale] duration-(--motion-quick) ease-out-strong can-hover:hover:bg-cutout focus-visible:bg-cutout active:scale-[0.97] active:duration-(--press)"
        >
