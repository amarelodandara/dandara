...
export function GiftShopSign({
  ...
  return (
    <header data-paper data-perforated className="-mx-5 -mt-8 bg-cadmium-400">
      <div
        data-perforated
      ...
      >
        ...
        <button
          ...
          data-pressable
          className="-mr-3 flex shrink-0 items-center rounded-lg bg-cadmium-50 px-2.5 py-2 shadow-cutout transition-[background-color,scale] duration-(--motion-quick) ease-out-strong can-hover:hover:bg-cadmium-200 focus-visible:bg-cadmium-200 active:scale-[0.97] active:duration-(--press)"
        >
      ...
      <p className={`px-8 py-3 ${LABEL} text-cadmium-900`}>{sign.blurb}</p>
    </header>
  );
}
